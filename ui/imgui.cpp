...
{
	s_state.hotToBe = s_state.hot = id;
}
...
static const int SLIDER_MARKER_WIDTH = 20;
static const int CHECK_SIZE = 16;
static const int DEFAULT_SPACING = 8;
static const int TEXT_HEIGHT = 16;
static const int SCROLL_AREA_PADDING = 12;
static const int INDENT_SIZE = 32;
static const int AREA_HEADER = 56;
#else
